...
function Home({ setPage }: { setPage: (p: string) => void }) {
  return (
    <div>
      <section className="relative bg-cover bg-center py-32 px-4 text-white text-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1200')" }}>
